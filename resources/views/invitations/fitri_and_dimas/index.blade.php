...
<html lang="en">
  <head>
    ...
    <meta
      property="og:image"
      content="{{ asset('assets/img/wedding/dimas1.jpg') }}"
    />
    <!-- cdn jquery -->
    ...
    <link
      rel="icon"
      href="{{ asset('assets/img/wedding/dimas1.jpg') }}"
    />
  ...
  <body oncontextmenu="return false">
    <div id="card" class="card fixed-top">
      <audio id="sound" preload="auto">
        <source
          src="/storage/song/Janji Suci.mp3"
          type="audio/mp3"
          preload="auto"
        />
      </audio>
    ...
    <div class="fixed-top">
      <div class="text-center">
        ...
        >
          ...
          <h2 style="font-size: 30px">Mengundang Anda Pada Acara Pernikahan Kami</h2>
          {{-- <p style="font-size: 25px">Kami Mengharap Kehadirannya</p> --}}
            ...
            <div class="col-md-4 m-0 p-0">
              <div class="card text-center shadow-lg bg-body-tertiary rounded">
                <a
                  ...
                  href="{{ asset('assets/img/wedding/fitri1.jpg') }}"
                >
                  <img
                    id="foto-profil-1"
                    style="display: none"
                    class="card-img-top img-fluid p-3 pb-5"
                    src="{{ asset('assets/img/wedding/fitri1.jpg') }}"
                    alt="..."
                  />
                </a>
              </div>
              ...
              >
                ...
                >
                  <img
                    ...
                    style="display: none"
                    class="card-img-top img-fluid p-3 pb-5"
                    src="{{ asset('assets/img/wedding/dimas1.jpg') }}"
                    alt="... "
                  />
                </a>
              </div>
          ...
          >
            <div class="row">
              <div class="col m-0 p-1">
                <a
                  data-fancybox="gallery"
                  href="{{ asset('assets/img/wedding/p4.jpg') }}"
                >
                  <img
                    id=""
                    style=""
                    class="img-fluid"
                    src="{{ asset('assets/img/wedding/p4.jpg') }}"
                    alt="... "
                  />
                </a>
              </div>
              <div class="col m-0 p-1">
                <a
                  data-fancybox="gallery"
                  href="{{ asset('assets/img/wedding/p2.jpg') }}"
                >
                  <img
                    id=""
                    style=""
                    class="img-fluid"
                    src="{{ asset('assets/img/wedding/p2.jpg') }}"
                    alt="... "
                  />
                </a>
              </div>
              <div class="col m-0 p-1">
                <a
                  data-fancybox="gallery"
                  href="{{ asset('assets/img/wedding/p3.jpg') }}"
                >
                  <img
                    id=""
                    style=""
                    class="img-fluid"
                    src="{{ asset('assets/img/wedding/p3.jpg') }}"
                    alt="... "
                  />
                </a>
              </div>
              <div class="col m-0 p-1">
                <a
                  data-fancybox="gallery"
                  href="{{ asset('assets/img/wedding/p1.jpg') }}"
                >
                  <img
                    id=""
                    style=""
                    class="img-fluid"
                    src="{{ asset('assets/img/wedding/p1.jpg') }}"
                    alt="... "
                  />
                </a>
              </div>
      ...
      <div class="m-0 p-0">
        ...
        >
          <div class="d-flex row m-0 p-0">
            ...
            <p class="col-md-12 m-0 p-0" text-align="center" style="font-size: 15px">
              Created By digitalsolutions.co.id
            </p>
          </div>
        </div>
      </div>
